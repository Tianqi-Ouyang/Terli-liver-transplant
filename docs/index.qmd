...
Plus a join-QC table, a cross-tabulation of the two listing definitions, and a [Bug Tracker](bugs.qmd) page covering the legacy `Code/*.Rmd` scripts, the shared pipeline and the EFU data.
...
| `docs/bugs.qmd` | Bug tracker — every bug found (legacy scripts, shared pipeline, EFU data) with cross-project status |
