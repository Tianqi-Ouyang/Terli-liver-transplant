...
|:--|:--|:--|
| S1 | Shared `create_table_one()` passes the Overall column into `pvalue()` → HTML p-values inflated | `pvalue()` redefined in the setup chunk and installed in the global env |
...
# --- Fix for shared-pipeline bug S1 (see bugs.qmd) -----------------------------------------
